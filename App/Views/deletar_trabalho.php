...
<div class="min-h-screen bg-gray-50 py-12 px-6">
    <div class="max-w-3xl mx-auto">
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900">Apagar Trabalho</h1>
            <p class="text-gray-500">Quer deletar o trabalho?.</p>
        </div>

        <form action="/trabalho/delete/<?=$trabalho->id?>" method="POST" class="bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-gray-100 space-y-8">
            <div>
