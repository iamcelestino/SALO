...
<body class="bg-gray-50 font-sans text-gray-900">
    ...
    <main class="max-w-6xl mx-auto py-12 px-6">
        <div class="flex flex-col lg:flex-row gap-8">
                ...
                <section class="lg:w-3/4 space-y-4">
                    ...
                    <div class="bg-white p-6 rounded-3xl border border-gray-100 hover:border-emerald-400 hover:shadow-xl transition group flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        <div class="flex gap-4">
                            ...
                            <div>
                                <h3 class="font-bold text-lg text-gray-900 group-hover:text-emerald-600 transition"><?=$trabalho->titulo;?></h3>
                                <p class="text-sm text-gray-500">Pro-Tec Angola • Remoto</p>
                                <div class="flex gap-2 mt-2">
                                    <span class="bg-gray-100 text-gray-600 text-[10px] font-bold px-2 py-1 rounded">
                                        <?=$trabalho->nivel_requerido;?>
                                    </span>
                                    <span class="bg-gray-100 text-gray-600 text-[10px] font-bold px-2 py-1 rounded">
                                        <?=$trabalho->tipo;?>
                                    </span>
                        ...
                        <div class="text-right w-full md:w-auto border-t md:border-none pt-4 md:pt-0">
                            <p class="font-bold text-emerald-700 text-lg"><?=$trabalho->orcamento?></p>
                            ...
                            <a href="/proposta/create/<?=$trabalho->id?>">Candidatar-se</a>
                        </div>
                    </div>
                    <?php endforeach ?>
            ...
            <?php else: ?>
            <h1>Não há trabalho por enquanto</h1>
        <?php endif ?>
        </div>
    </main>
</body>
