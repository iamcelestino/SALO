   ...
   <main class="min-h-screen flex items-center justify-center p-6">
        <div class="max-w-4xl w-full bg-white rounded-3xl shadow-xl overflow-hidden flex flex-col md:flex-row border border-gray-100">
            ...
            <div class="md:w-1/3 bg-emerald-700 p-10 text-white flex flex-col justify-between">
                <div>
                    <div class="text-xl font-bold mb-6">JobStream</div>
                    <h2 class="text-2xl font-bold mb-4">Nova Proposta</h2>
                ...
                <form action="/proposta/create/3" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="valor_proposto" id="valor_proposto" placeholder="0.00" 
                    ...
                    <div>
                        ...
                        <textarea name="mensagem" id="mensagem" rows="5" 
                            ...
                            placeholder="Descreva sua experiência e como você pode ajudar..."></textarea>
                    </div>
