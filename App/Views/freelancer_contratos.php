    ...
    <div class="flex min-h-screen">
        <aside class="w-64 bg-emerald-950 text-white hidden md:flex flex-col sticky top-0 h-screen">
            ...
            <nav class="flex-1 px-4 space-y-2">
                ...
                <a href="/contrato/freelancer" class="flex items-center gap-3 px-4 py-3 bg-emerald-800 rounded-xl text-white font-medium">
                    <span>📄</span> Contratos
                </a>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <?php foreach($contratos as $contrato): ?>
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap"><?= $contrato->cliente_nome ?></td>
